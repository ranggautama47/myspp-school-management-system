<x-filament-panels::page.simple>
    ...
    <style>
        ...
        /* ── Custom Scrollbar ── */
        .myspp-scrollbar::-webkit-scrollbar {
            width: 5px;
        }
        .myspp-scrollbar::-webkit-scrollbar-track {
            background: transparent;
        }
        .myspp-scrollbar::-webkit-scrollbar-thumb {
        ...
        >
            <div style="max-width: 380px; margin: 0 auto; width: 100%">
                ...
                <div style="text-align: center; margin-bottom: 36px">
                    ...
                    >Harap baca dengan seksama sebelum melanjutkan</p>
                </div>
                ...
                >
                    ...
                    <p
                        style="
                            ...
                            padding-left: 36px;
                        "
                    >Kami berkomitmen melindungi data pribadi Anda. Semua informasi hanya digunakan untuk keperluan administrasi sekolah dan tidak dibagikan kepada pihak ketiga tanpa izin.</p>
                    {{-- Kebijakan Privasi --}}
                    <label
                        class="flex items-center gap-3 cursor-pointer mt-4 select-none group"
                    >
                        <input
                            type="checkbox"
                            id="privacy_check"
                            class="w-5 h-5 rounded bg-slate-800 border-slate-700 text-emerald-500 focus:ring-emerald-500/30 focus:ring-offset-0 focus:ring-offset-transparent cursor-pointer flex-shrink-0 transition-all"
                        />
                        <span
                            class="text-sm text-slate-400 leading-relaxed group-hover:text-slate-300 transition-colors"
                        >
                ...
                >
                    ...
                    <p
                        style="
                            ...
                            padding-left: 36px;
                        "
                    >Dengan menggunakan MySPP, Anda setuju mematuhi semua syarat dan ketentuan yang berlaku. Pastikan Anda memahami seluruh ketentuan sebelum menggunakan layanan.</p>
                    {{-- Syarat & Ketentuan --}}
                    <label
                        class="flex items-center gap-3 cursor-pointer mt-4 select-none group"
                    >
        ...
        >
            ...
            >
                ...
                <div style="text-align: center; margin-bottom: 32px">
                    ...
                    <p
                        style="font-size: 13px; color: #64748b; margin: 0"
                    >Masuk untuk mengakses dashboard admin</p>
                </div>
                ...
                <p
                    style="
                        ...
                        margin-top: 20px;
                    "
                >&copy; {{ date("Y") }} MySPP. All rights reserved.</p>
            </div>
        </div>
    </div>
    ...
    {{-- Toast notifikasi --}}
    <div id="myspp-toast">
        ⚠ Harap centang Kebijakan Privasi dan Syarat & Ketentuan terlebih dahulu
    </div>
            ...
            document.addEventListener(
                ...
                function (e) {
                    const btn = e.target.closest(
                        '.fi-form-actions .fi-btn, button[type="submit"]',
                    );
                    if (!btn) return;
                    if (!privacyCb.checked || !termsCb.checked) {
                        e.preventDefault();
